...
def generate_bg(num_bg_images):
    found = False
    while not found:
        fname = "E:/project data/bgs/{:08d}.jpg".format(random.randint(0, num_bg_images - 1))
...
if __name__ == "__main__":
    ...
    for img_idx, (im, c, p) in enumerate(im_gen2):
        fname = "E:/project data/test/{:08d}_{}_{}.png".format(img_idx, c,
                                               "1" if p else "0")
        ...
        fname='E:/project data/test/'+fname+'.png'
